...
const SB_POPUP_LOGOS = Object.freeze({
  horizontal: '/streaming_browser/assets/streaming-browser-horizontal.png?v=0.4.122',
  vertical: '/streaming_browser/assets/streaming-browser-vertical.png?v=0.4.122',
  icon_only: '/streaming_browser/assets/streaming-browser-icon.png?v=0.4.122',
});
